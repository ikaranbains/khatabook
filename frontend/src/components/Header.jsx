...
import { TrendingUp, LayoutGrid, CreditCard, Target } from "lucide-react";
    ...
    >
      <div className="rounded-2xl px-4 sm:px-6 py-3 border-2 border-black/10 bg-white/80 backdrop-blur-sm shadow-[0_8px_0_rgba(21,21,19,0.08)]">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-8">
          ...
          <nav className="w-full sm:w-auto flex items-center justify-between sm:justify-start space-x-1 bg-[#f1eee6] px-1 sm:px-1.5 py-1 sm:py-1.5 rounded-xl border-2 border-black/10 overflow-x-auto">
